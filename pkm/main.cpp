...
///MOVER EL HANDLE A CLASSES, CALL ANEL
...
*/
void gotoxy(int x, int y) /// ¿Para que sirve gotoxy()? , Bueno sencillamente nos permite manipular la posición en la
                          /// pantalla de lo que nuestra aplicación envié de salida, pueden ser caracteres, números, etc.
{
    HANDLE hCon;
    COORD dwPos;
